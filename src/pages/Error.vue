                ...
                <div class="h-full w-full m-0 py-7 px-4" style="border-radius:53px; background: linear-gradient(180deg, var(--surface-50) 38.9%, var(--surface-0));">
                    <div class="grid flex flex-column align-items-center">
                        ...
                        <div class="col-12 mt-2 text-center">
                            <i class="pi pi-fw pi-unlock text-blue-500 mr-2" style="vertical-align:center;"></i>
                            <router-link to="/" class="text-blue-500">Back to Main</router-link>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    methods: {
        // if user chooses to return to the login page, they will be logged out
        logout() {
